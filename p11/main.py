    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if ((xPos > pokemon_x) and (xPos < pokemon_x + 70)
                ...
                pokemon_y = random.randint(0,520)
                iteration_count = 0
                hit += 999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
